    ...
    <div class="container">
        ...
        <form action="{{ route('book.update', $book->id) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="thumbnail" class="form-control" value="{{ $book->thumbnail }}" id="">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="publisher" class="form-control" value="{{ $book->publisher }}" id="">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Publication</label>
                <input type="date" name="publication" class="form-control" value="{{ $book->publication }}" id="">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Price</label>
                <input type="number" step="0.1" name="price" class="form-control" value="{{ $book->price }}" id="">
            </div>
            <div class="mb-3">
